...
你治疗技能的效果会受到你的增益幅度和目标的恢复强度的共同影响。"""
guide['防御'] = """防御由感知决定。
...
guide['生命窃取'] = """角色普通攻击造成伤害后，根据造成伤害的一定比例回复生命，恢复量与伤害量和生命窃取倍率相关，不会受到恢复强度的加成。
对护盾造成的伤害和对自身的伤害无法参数生命窃取的计算。"""
guide['护盾'] = """角色一次只能拥有一个护盾，无法叠加，护盾会优先使用数值更大的那个。
