...
"""}, {
        ...
        "log": """
——平衡更新——
[魔粉]组词缀的法术倍率提升效果的持续时间由7回合上调至8回合。
[魔法药机]组词条的法术倍率提升效果的持续时间由7回合上调至8回合。
[魔法激活]组技能的法术倍率提升最大值下调至32%，效果持续时间由7回合上调至8回合。

[技能过载]组必杀的技能发动率提高效果由24%上调至30%。
[黑魔法]组必杀的MP消耗量上调至40%，每点MP转化的法术倍率下调至0.75%。
[会心]组必杀的暴击MP需求量由300下调至275。
"""}, {
        "version": "Alpha 6.2.9",
        "log": """
——平衡更新——
[灭杀之焰]组必杀魔法伤害由251上调至257，被动普通攻击带来的法术倍率提高效果由4.2%上调至5%。
[毁灭之雨]组必杀魔法伤害由162上调至170，法术倍率提高效果由44%下调至40%，持续时间由8回合上调至10回合，MP恢复量由450下调至420，不再提高MP获取速度，角色在进入战斗时额外拥有300点MP。
[沉默的猎杀者]组必杀暴击率提升效果由72%上调至90%。
[天使降临]组必杀现在额外有MP获取速度提高35%的效果。
[黑魔法]初始MP由120下调至50。
[会心]组必杀的暴击MP需求量由300下调至210。

[远距瞄准]组技能冷却时间由4t5缩短至3t4，MP消耗期望下调至75；不再提供攻击力提高效果，暴击率提高效果由30%上调至50%，持续时间由5回合下调至4回合。
[守护之诺]组技能的伤害抵抗标记现在可以抵抗两次攻击，恢复强度提高效果由45%下调至15%。
[魔法激活]组技能的冷却时间由2t3上调至3t4，法术倍率提升最大值由32%上调至42%，MP消耗期望上调至170。
[复仇火花]技能带来的法术倍率提升效果持续时间由4回合下调至3回合。

[弱点锁定]组词条的暴击率提升效果由27%上调至34%。

——错误修复——
修正了[黑魔法]描述中，临时法术倍率的展示小数位数(实际效果未改动)。
"""}, {
        "version": "Alpha 6.3.0",
        "log": """
——技能更新——
[闪避光环]组必杀新效果：
    使全队在2回合内完全闪避普通攻击，期间，当角色第一次触发闪避效果时，获得攻击标记。
    
新必杀：[血戮魔法]：
    治疗自身少量生命。
    被动：普通攻击替换为献祭攻击：以自身为目标进行普通攻击，同时提高自身法术倍率；角色的恢复强度将会被自身的法术倍率替代。
    
——平衡更新——
[狂怒战神]组必杀现在会在使用必杀的回合额外进行一次普通攻击，攻击力提升效果由300点下调至225点，持续时间由4回合下调至3回合。
[沉默的猎杀者]组必杀不再拥有必中效果，现在会中幅提升自身的攻击力。
[先知的祝福]组必杀法术倍率提高效果由128%上调至141%，不再拥有MP消耗降低效果。
[碎裂拳]组必杀的攻击伤害降低效果由43%上调至45%。
[主技能爆发]组必杀技能发动率提高效果上调至40%，新增MP消耗降低效果，使MP消耗降低至50%。
[扼杀]组必杀现在拥有必中效果，MP获取速度由101%上调至121%。


——错误修复——
尝试修正了战斗中可能会导致游戏崩溃的问题。"""
    }
]
